...
export default function HomeScreen() {
  ...
  // تنسيق التاريخ والوقت بتوقيت اليمن (+3)
  const formatYemenDateTime = () => {
    const yemenTime = new Date(currentDateTime.getTime() + (3 * 60 * 60 * 1000)); // إضافة 3 ساعات
    const day = getArabicDayName(yemenTime);
    const dayNum = yemenTime.getUTCDate();
    const month = getArabicMonthName(yemenTime);
    const year = yemenTime.getUTCFullYear();
    const hours = yemenTime.getUTCHours();
    const minutes = yemenTime.getUTCMinutes().toString().padStart(2, '0');
        ...
        <View style={styles.welcomeCard}>
          ...
          <View style={styles.dateTimeContainer}>
            <View style={styles.dateTimeRow}>
              ...
              <Text style={styles.dateTimeText}>{formatYemenDateTime().dayName}، {formatYemenDateTime().fullDate}</Text>
            </View>
            <View style={styles.dateTimeRow}>
              <Ionicons name="time-outline" size={16} color="#1565c0" />
              <Text style={styles.dateTimeText}>{formatYemenDateTime().time}</Text>
            </View>
          </View>
              ...
              <View style={styles.teacherSectionHeader}>
                ...
                <View>
                  ...
                  <Text style={styles.teacherSectionDate}>
                    {formatGregorianDate(new Date(), { includeWeekday: true, includeYear: false })}
                  </Text>
                </View>
            ...
            <View style={styles.calendarSection}>
              ...
              <View style={styles.calendarHeader}>
                ...
                <Text style={styles.calendarTitle}>
                  {formatMonthYear(currentMonth, false)}
                </Text>
                <TouchableOpacity 
                  style={[styles.calendarNavBtn,
