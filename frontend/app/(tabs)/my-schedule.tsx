...
// استخدام الثوابت من dateUtils
const DAYS_AR = WEEKDAYS_AR;
const DAYS_SHORT = WEEKDAYS_AR_SHORT;
const MONTHS_AR = GREGORIAN_MONTHS_AR;
        ...
        <View style={styles.monthCard}>
          ...
          <View style={styles.monthHeader}>
            ...
            <View style={styles.monthTitleContainer}>
              ...
              <Text style={styles.monthTitleHijri}>
                {formatHijriDate(currentMonth, { includeYear: true })}
              </Text>
            </View>
            <TouchableOpacity 
              onPress={() => navigateMonth(1)} 
