            ...
            <ScrollView style={styles.modalBody}>
              ...
              {Platform.OS === 'web' ? (
                <input
                  ...
                  onChange={(e: any) => setSemesterForm(prev => ({ ...prev, start_date: e.target.value }))}
                  style={{
                    width: '100%',
                    padding: '12px',
                    borderRadius: '8px',
              ...
              {Platform.OS === 'web' ? (
                <input
                  ...
                  onChange={(e: any) => setSemesterForm(prev => ({ ...prev, end_date: e.target.value }))}
                  style={{
                    width: '100%',
                    padding: '12px',
                    borderRadius: '8px',
